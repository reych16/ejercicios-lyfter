...
def list_students(students):
    ...
    for student in students:
        ...
        print(
            f"{index}. {student.full_name} [{student.section}] "
            f"- Spa:{student.spanish_grade} Eng:{student.english_grade} "
            f"Soc:{student.social_grade} Sci:{student.science_grade} | Avg:{average:.2f}"
        )
        index = index + 1
